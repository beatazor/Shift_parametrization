...
# Choose the method and the test case
plt.close("all")
# method = "shifted_POD"
method = "shifted_rPCA"
case = "crossing_waves"
...
fig, ax = plt.subplots(1, 4, figsize=(15, 4), gridspec_kw=gridspec, num=101)
mycmap = "viridis"
...
save_fig(impath + "01_traveling_wave_1D_Frames.png", fig)
plt.show()


#%% visualize your results: relative error
